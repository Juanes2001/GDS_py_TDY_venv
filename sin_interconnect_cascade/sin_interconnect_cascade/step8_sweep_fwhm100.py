"""
step8_sweep_fwhm100.py — full cascade sweep with the FWHM~100 pm coupling variant (kappa_01).

Identical engine to step 7 but with the narrowest FWHM~100 pm
couplers (kappa_01, stored under the _02 helper suffix in the
original notebook). Produces the highest-finesse drop spectra used
in the FWHM comparison.
"""
...
from .step6_kappa_variants import (
    RING_KAPPA_INPUT_SQ_01, RING_KAPPA_DROP_SQ_01,
)
...
def run(state=None):
    ...
    global FIGURES_DIR_02, HDF5_PATH_02, VERSION_NAME_02, computed_02, f02_1, f02_10, f02_11, f02_12, f02_13, f02_14, f02_15, f02_16, f02_2, f02_3, f02_4, f02_5, f02_6, f02_7, f02_8, f02_9, sweep_results_02, wl_02, wl_nm_02
    ...
    state.update({k: globals().get(k) for k in [
        'FIGURES_DIR_02', 'HDF5_PATH_02', 'VERSION_NAME_02', 'computed_02', 'f02_1', 'f02_10',
        'f02_11', 'f02_12', 'f02_13', 'f02_14', 'f02_15', 'f02_16',
        'f02_2', 'f02_3', 'f02_4', 'f02_5', 'f02_6', 'f02_7',
        'f02_8', 'f02_9', 'sweep_results_02', 'wl_02', 'wl_nm_02',
    ] if k in globals()})
    return state
